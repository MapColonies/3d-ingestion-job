...
export class InitialCreate1613997622155 implements MigrationInterface {
  public name = 'InitialCreate1613997622155';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "jobs" (
        ...
        "status" "jobs_status_enum" NOT NULL DEFAULT 'In-Progress', 
        "created" TIMESTAMP NOT NULL DEFAULT '"2021-02-22T12:40:23.655Z"', 
        "updated" TIMESTAMP NOT NULL DEFAULT '"2021-02-22T12:40:23.655Z"', 
